...
import static hu.bono.bigbank.dragons.game.application.GameClient.POST_URL;
...
class GameClientTest {
    ...
    private final GameClient underTest = new GameClient(RestClient.create(restTemplate));
    ...
    void testPostGameReturnsPostGameResponseWhenHttpStatusIs2xx() throws Exception {
        ...
        restServiceServer.expect(requestTo(POST_URL))
    ...
    @Test
    void testPostGameReturnsRestClientClientExceptionWhenHttpStatusIs4xx() throws Exception {
        restServiceServer.expect(requestTo(POST_URL))
    ...
    @Test
    void testPostGameReturnsRestClientServerExceptionWhenHttpStatusIs5xx() throws Exception {
        restServiceServer.expect(requestTo(POST_URL))
